...
# Time 4
# Generates Table 5, Table 6 and Table 7
...
names(df_reduced_variables_time3)[1:12] <- paste0(names(df_reduced_variables_time3)[1:12],
                                                  "time3")

rm(list=setdiff(ls(), list("df_reduced_variables_time3")))
...
freq <- t(sapply(df_reduced_variables_time4[, colnames(df_reduced_variables_time4) %in% top_4], table))[as.character(top_4),]
...
### ROW 1
split1 <- df_reduced_variables_time4[df_reduced_variables_time4$gsw_groupstime3 == 1 |
                                       df_reduced_variables_time4$gsw_groupstime3 == 2, ]
split2 <- df_reduced_variables_time4[df_reduced_variables_time4$gsw_groupstime3 == 3 ,]
split3 <- df_reduced_variables_time4[df_reduced_variables_time4$gsw_groupstime3 == 4,]
...
#### ROW 3
split1 <- df_reduced_variables_time4[df_reduced_variables_time4$pa_groups == 1 |
                                       df_reduced_variables_time4$pa_groups == 2,]
split2 <- df_reduced_variables_time4[df_reduced_variables_time4$pa_groups == 3 ,]
split3 <- df_reduced_variables_time4[df_reduced_variables_time4$pa_groups ==  4,]
splitted_datasets <- list(split1, split2, split3)
df_entropy_var_split <- list()
top_3_split <- list()
