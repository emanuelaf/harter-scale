...
# Time 2
# Generates Table 2, Table 3 and Table 4
...
df_reduced_variables_time2 <- df_reduced_variables_time2 %>%
  select(-ID)
rm(list=setdiff(ls(), list("df_reduced_variables_time2", "timestamp", "k", "ci", "mce", "conditional_entropy")))
...
t(sapply(df_reduced_variables_time2[, colnames(df_reduced_variables_time2) %in% top_4], table))[as.character(top_4),]
...
### ROW 1
top_4[1]
split1 <- df_reduced_variables_time2[df_reduced_variables_time2$pa_groups == 1 |
                                     df_reduced_variables_time2$pa_groups == 2, ]
split2 <- df_reduced_variables_time2[df_reduced_variables_time2$pa_groups == 3 ,]
split3 <- df_reduced_variables_time2[df_reduced_variables_time2$pa_groups == 4,]
...
#### ROW 2
top_4[2]
split1 <- df_reduced_variables_time2[df_reduced_variables_time2$psw_groups == 1 |
                                 df_reduced_variables_time2$psw_groups == 2,]
split2 <- df_reduced_variables_time2[df_reduced_variables_time2$psw_groups == 3 ,]
split3 <- df_reduced_variables_time2[df_reduced_variables_time2$psw_groups ==  4,]
splitted_datasets <- list(split1, split2, split3)
df_entropy_var_split <- list()
top_3_split <- list()
...
#### ROW 3
top_4[3]
split1 <- df_reduced_variables_time2[df_reduced_variables_time2$gsw_groupstime1 == 1 |
                                 df_reduced_variables_time2$gsw_groupstime1 == 2,]
split2 <- df_reduced_variables_time2[df_reduced_variables_time2$gsw_groupstime1 == 3 ,]
split3 <- df_reduced_variables_time2[df_reduced_variables_time2$gsw_groupstime1 ==  4,]
splitted_datasets <- list(split1, split2, split3)
df_entropy_var_split <- list()
top_3_split <- list()
...
### ROW 4
top_4[4]
split1 <- df_reduced_variables_time2[df_reduced_variables_time2$ps_groups == 1 |
                                       df_reduced_variables_time2$ps_groups == 2,]
split2 <- df_reduced_variables_time2[df_reduced_variables_time2$ps_groups == 3 ,]
split3 <- df_reduced_variables_time2[df_reduced_variables_time2$ps_groups ==  4,]
splitted_datasets <- list(split1, split2, split3)
df_entropy_var_split <- list()
top_3_split <- list()
